...
const TOP_KEYWORDS = {
    ...
    longTail: [
        ...
        // Tool keywords - CÔNG CỤ XỔ SỐ (MỞ RỘNG TỐI ĐA)
        // Tạo dàn đề - Tất cả variations
        'tạo dàn đề',
        'tao dan de',
        'tạo dàn đề 9x0x',
        'tạo dàn đề 9x-0x',
        ...
        'du doan xo so mien bac',
        
        // Thống kê - Tất cả variations
        'thống kê lô gan',
        'thong ke lo gan',
        'lô gan',
        'lo gan',
        ...
        // Kết quả xổ số - Tất cả variations
        'kết quả xổ số',
        'ket qua xo so',
        'ket qua xoso',
        'ketqua xoso',
